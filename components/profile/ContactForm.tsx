...
export function ContactForm() {
  ...
  return (
    <div className="iso-card p-6 md:p-7">
      ...
      <p className="text-sm text-muted mb-5">A brief note is enough — I’ll reply within a day.</p>
      ...
      <form action={action} className="space-y-3.5">
        ...
        <Submit />
        <p className="font-mono text-[10px] tracking-wide text-muted text-center">No spam — just a direct message.</p>
      </form>
    </div>
  );
}
